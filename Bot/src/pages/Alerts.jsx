              ...
              {alerts.length === 0 ? (
                ...
                alerts.map((alert) => (
                  ...
                  >
                    ...
                    <td className="p-4">
                      <span
                        className={`px-2 py-0.5 rounded-full font-bold text-xs ${alert.confidence > 80
                    ...
                    <td className="p-4">
                      <span
                        className={`px-2.5 py-1 rounded-full text-xs font-semibold flex items-center gap-1.5 w-fit ${alert.status === "Active"
                            ? "bg-red-100 text-red-600 border border-red-300 animate-pulse"
                            : "bg-emerald-100 text-emerald-600 border border-emerald-300"
                          }`}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${alert.status === "Active"
                              ? "bg-red-500"
                              : "bg-emerald-500"
                            }`}
                        ></span>
